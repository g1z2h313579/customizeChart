...
export default (props) => {
    return (
        <>
            ...
            <div className='tagName blockClass'>
                <div>
                    <span className='title'>标签1</span>
                    <Input style={{ width: 'calc(100% - 35px)' }} value={props.tagName[0]} onChange={(e) => {props.tagNameOnChange(e, 0)}} />
                </div>
                <div>
                    <span className='title'>标签2</span>
                    <Input style={{ width: 'calc(100% - 35px)' }} value={props.tagName[1]} onChange={(e) => {props.tagNameOnChange(e, 1)}} />
                </div>
                <div>
                    <span className='title'>标签3</span>
                    <Input style={{ width: 'calc(100% - 35px)' }} value={props.tagName[2]} onChange={(e) => {props.tagNameOnChange(e, 2)}} />
                </div>
            </div>
        </>
    )
